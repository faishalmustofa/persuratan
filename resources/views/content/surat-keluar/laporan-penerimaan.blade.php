...
@section('title', 'Surat Keluar - Laporan Penerimaan Surat Keluar')
...
@section('page-script')
  <script src="{{asset('assets/js/transaction/laporan-penerimaan-surat-keluar.js')}}"></script>
  <script>
    $(function () {
    });
  </script>
...
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">Surat Keluar /</span> Laporan Penerimaan Nomor Surat
</h4>
    ...
    <div class="col-md">
        <div class="card">
            <div class="card-header">
                Daftar Laporan Penerimaan Nomor Surat
            </div>
            <div class="card-body">
...
{{-- <div class="row mb-4">
    <div class="col-md">
        <div class="card">
            <div class="card-header">
                Log Laporan Penerimaan Nomor Surat Keluar
            </div>
            <div class="card-body">
              <div class="card-datatable table-responsive pt-0">
        ...
        <div class="modal-content">
            ...
            @csrf
                <div class="modal-header">
                    <h5 class="modal-title" id="modalCenterTitle">Detail Laporan Penerimaan Nomor Surat</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                        <div class="card text-white bg-primary rounded-pills mb-4">
                            <div class="card-body">
                                <h5 class="card-title text-white">Informasi Surat</h5>
                                <div class="row justify-content-center align-items-center" id="header-data">
                                    ...
                                    <div class="col-md-4 col-12 mb-2">Tanggal Surat</div>
                                    <div class="col-md-1 col-12 mb-2"> : </div>
                                    <div class="col-md-7 col-12 mb-2">
