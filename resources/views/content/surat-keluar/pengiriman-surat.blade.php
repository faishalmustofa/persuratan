...
@section('title', 'Surat Keluar - Pengiriman Surat')
...
@section('page-script')
  <script src="{{asset('assets/js/transaction/pengiriman-surat-keluar.js')}}"></script>
  <script>
    $(function () {
    });
  </script>
...
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">Surat Keluar /</span> Pengiriman Surat Keluar
</h4>
    ...
    <div class="col-md">
        <div class="card">
            <div class="card-header">
                Daftar Pengiriman Surat Keluar
            </div>
            <div class="card-body">
...
<div class="row mb-4">
  <div class="col-md">
      <div class="card">
          <div class="card-header">
              Log Data Pengiriman Surat Keluar
          </div>
          <div class="card-body">
